...
return ( <header className="sticky top-0 z-50 border-b border-[#e7dddf] bg-white/95 backdrop-blur"> <div className="mx-auto flex h-18 max-w-7xl items-center justify-between px-5 lg:px-8">
