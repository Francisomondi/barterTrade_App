  ...
  return (
    <div className="min-h-screen bg-[#F8F5F3]">
      ...
      <section className="relative isolate overflow-hidden bg-[#3D0F18]">
        ...
        <div className="absolute inset-0 -z-10 bg-[#3D0F18]/2" />

        {/* MAROON GRADIENT */}

        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#3D0F18]/95 via-[#5B1725]/85 to-[#8A2638]/70" />

        {/* DECORATIVE 3D GLOWS */}

        <div className="absolute -right-32 -top-32 -z-10 h-[450px] w-[450px] rounded-full bg-[#8A2638]/30 blur-3xl" />

        <div className="absolute -bottom-48 left-10 -z-10 h-[400px] w-[400px] rounded-full bg-[#701F30]/30 blur-3xl" />
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-2xl text-base leading-7 text-white/75 md:text-lg">
              ...
              Exchange items of similar
              value with people around
              you. No complicated buying
              process. Just find an item,
              make an offer and trade.
            ...
            <div className="mt-10 max-w-4xl">
              ...
              <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/10 p-3 shadow-2xl backdrop-blur-xl md:flex-row">

                <div className="relative flex-1">

                  <div className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-xl text-gray-400">
                    🔍
                  </div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-10 md:py-14">
        ...
        <section>
          ...
          <div className="mb-6 flex items-end justify-between">
            ...
            <div>
              ...
              <h2 className="mt-1 text-2xl font-extrabold text-[#21191B] md:text-3xl">
                Browse categories
              </h2>
            ...
            {categoryId && (
              <button
                ...
                className="text-sm font-semibold text-[#8A2638] hover:text-[#5B1725]"
              >
                Clear
              </button>
            )}
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <select
                ...
                className="rounded-xl border border-[#E7DDDF] bg-[#FBF5F6] px-5 py-3 text-sm font-medium text-gray-700 outline-none transition focus:border-[#8A2638] focus:ring-2 focus:ring-[#8A2638]/10"
              >
        ...
        <section className="mt-12">
          ...
          <div className="mb-7 flex items-end justify-between">
            ...
            <div className="hidden rounded-full bg-[#F5E8EB] px-4 py-2 text-sm font-bold text-[#5B1725] sm:block">
            ...
            listings.length === 0 && (
              <div className="rounded-2xl border border-[#E7DDDF] bg-white px-6 py-24 text-center shadow-sm">
                ...
                <button
                  ...
                  className="mt-6 rounded-xl bg-[#5B1725] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#3D0F18]"
                >
                  Browse all items
                </button>
