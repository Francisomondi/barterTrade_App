...
const isMatchOffer =
Boolean(requestedListingId && offeredListingId);
...
setError("");
    ...
    /*
     * Always load the exact requested listing.
     */
     ...
     * ======================================================
     *
     * If we arrived here from Matches.jsx, we already know
     * exactly which listing the user wants to offer.
     *
     * Load ONLY that listing.
     */
    if (isMatchOffer) {
     ...
     * ======================================================
     *
     * Existing /make-offer/:id flow continues to work.
     */
...
try {
   ...
   * Keep this as JSON.
   *
   * Your backend createOffer expects req.body.
   */
  const offerData = {
    receiverId:
...
if (loading) {
return ( <div className="min-h-screen bg-[#F8F5F3] px-6 py-12"> <div className="mx-auto max-w-6xl"> <div className="animate-pulse"> <div className="h-10 w-48 rounded-lg bg-[#E7DDDF]" />
...
return ( <div className="min-h-screen bg-[#F8F5F3] px-4 py-16 sm:px-6 sm:py-20"> <div className="mx-auto max-w-lg rounded-2xl border border-red-200 bg-white p-7 text-center shadow-sm sm:p-9"> <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-red-50 text-xl font-bold text-red-600">
! </div>
      ...
      <button
        type="button"
        onClick={() => navigate(-1)}
        className="mt-6 rounded-xl bg-[#5B1725] px-5 py-2.5 text-sm font-bold text-white transition hover:bg-[#3D0F18]"
      >
        Go back
      </button>
    </div>
...
return ( <div className="min-h-screen bg-[#F8F5F3]">
  ...
  <section className="relative overflow-hidden bg-[#3D0F18]">
    ...
    <div className="relative mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 text-xs font-semibold text-white/65 transition hover:text-white sm:text-sm"
      >
      ...
      <div className="mt-6">
        ...
        <p className="mt-2 max-w-xl text-sm leading-6 text-white/65 sm:text-[15px]">
          {isMatchOffer
            ? "Review the matched items below and send your barter offer."
  ...
  <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
    ...
    <div className="grid items-stretch gap-4 lg:grid-cols-[1fr_auto_1fr] lg:gap-5">
      ...
      <div className="flex items-center justify-center lg:px-1">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#5B1725] text-xl text-white shadow-md">
            ⇄
          </div>
    ...
    <form
      ...
      className="mt-5 overflow-hidden rounded-2xl border border-[#E7DDDF] bg-white shadow-sm"
    >
      ...
      <div className="border-b border-[#F0E8EA] px-4 py-5 sm:px-6">
        ...
        <p className="mt-1 text-xs leading-5 text-gray-500 sm:text-sm">
          {isMatchOffer
            ? "This is the item selected from your match. It will be sent as your offer."
        ...
        <div className="px-4 py-8 sm:px-6 sm:py-10">
          ...
          <div className="rounded-xl border border-dashed border-[#D8C5C9] bg-[#FBF5F6] p-7 text-center">
            ...
            <button
              ...
              className="mt-4 rounded-xl bg-[#5B1725] px-5 py-2.5 text-xs font-bold text-white shadow-sm transition hover:bg-[#3D0F18] sm:text-sm"
            >
              Create Listing
            </button>
        ...
        <div className="px-4 py-5 sm:px-6">
          ...
          <div className="mt-6 border-t border-[#F0E8EA] pt-5">
            ...
            <textarea
              ...
              className="mt-2 w-full resize-none rounded-xl border border-[#E7DDDF] bg-[#FBF5F6] px-4 py-3 text-sm leading-6 text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-[#8A2638] focus:bg-white focus:ring-4 focus:ring-[#8A2638]/10"
            />
          ...
          <div className="mt-5 flex flex-col-reverse gap-2.5 sm:flex-row sm:justify-end">
            ...
            <button
              ...
              className="rounded-xl border border-[#E7DDDF] bg-white px-5 py-3 text-sm font-bold text-gray-600 transition hover:bg-[#FBF5F6] hover:text-[#5B1725]"
            >
              Cancel
            </button>
            ...
            <button
              ...
              className="rounded-xl bg-[#5B1725] px-7 py-3 text-sm font-bold text-white shadow-md transition-all hover:bg-[#3D0F18] hover:shadow-lg active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
            >
              {submitting
                ? "Sending offer..."
                : "Send Barter Offer →"}
